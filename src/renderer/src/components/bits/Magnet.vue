...
/** Vue Bits — Animations/Magnet (https://vue-bits.dev/animations/magnet). Unmodified. */
...
const handleMouseMove = (e: MouseEvent): void => {
  ...
  if (distX < width / 2 + props.padding && distY < height / 2 + props.padding) {
    isActive.value = true
    position.value = { x: (e.clientX - centerX) / props.magnetStrength, y: (e.clientY - centerY) / props.magnetStrength }
  } else {
