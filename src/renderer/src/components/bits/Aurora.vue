...
/** Vue Bits — Backgrounds/Aurora (https://vue-bits.dev/backgrounds/aurora). Unmodified. */
...
onMounted(() => {
  ...
  program = new Program(gl, {
    ...
    uniforms: {
      ...
      uColorStops: { value: props.colorStops.map(toRGB) },
  ...
  const update = (t: number): void => {
    ...
    if (program && renderer) {
      ...
      program.uniforms.uColorStops.value = props.colorStops.map(toRGB)
