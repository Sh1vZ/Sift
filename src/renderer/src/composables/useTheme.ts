...
export const THEMES: ThemeDef[] = [
  {
    id: 'sift',
    name: 'Sift',
    description: 'The default. Indigo-black surfaces, neon violet identity, rose held in reserve.',
    oled: false,
    colors: {
      bg0: '#0a0a18',
      bg1: '#0f0f23',
  ...
  },
  {
    id: 'ember',
    name: 'Ember',
    description: 'Warm charcoal ground with an orange identity and gold punctuation.',
    oled: false,
    colors: {
      bg0: '#0b0807',
      bg1: '#110e0c',
  ...
  },
  {
    id: 'arctic',
    name: 'Arctic',
    description: 'Blue-black ground with a sky identity and teal punctuation.',
    oled: false,
    colors: {
      bg0: '#060a13',
      bg1: '#0a101b',
  ...
  },
  {
    id: 'synthwave',
    name: 'Synthwave',
    description: 'Deep purple ground with a hot pink identity and cyan punctuation.',
    oled: false,
    colors: {
      bg0: '#0b0516',
      bg1: '#10081d',
  ...
  },
  {
    id: 'verdant',
    name: 'Verdant',
    description: 'Green-black ground with a leaf-green identity and gold punctuation.',
    oled: false,
    colors: {
      bg0: '#070c09',
      bg1: '#0b120e',
    ...
    spotlight: 'rgba(134, 239, 172, 0.24)'
  },
  {
    id: 'crimson',
    name: 'Crimson',
    description: 'Red-black ground with a crimson identity and amber punctuation.',
    oled: false,
    colors: {
      bg0: '#0f0708',
      bg1: '#150a0c',
  ...
  },
  {
    id: 'solar',
    name: 'Solar',
    description: 'Warm graphite ground with a golden identity and sky punctuation.',
    oled: false,
    colors: {
      bg0: '#0a0a08',
      bg1: '#10100d',
