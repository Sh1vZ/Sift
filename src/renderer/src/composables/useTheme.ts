...
export const THEMES: ThemeDef[] = [
  ...
  },
  {
    id: 'nox',
    name: 'Nox',
    description: 'Deep plum ground with a magenta identity and amber punctuation.',
    oled: false,
    colors: {
      bg0: '#1a0916',
      bg1: '#150811',
  ...
  },
  {
    id: 'grim',
    name: 'Grim',
    description: 'Near-black forest ground with a sage identity and terracotta punctuation.',
    oled: false,
    colors: {
      bg0: '#011502',
      bg1: '#000a01',
